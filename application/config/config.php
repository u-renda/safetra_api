...
/* privillage API KEY */
$config['allow_api_key'] = array('bd6fb882067e6ok56GR93376cd411ee');

if(is_bool(LOCALHOST) || LOCALHOST == 'localhost')
{
    $config['link_photo'] = 'http://localhost/safetra_web/upload/';
    
    define('WEB_HOST', 'http://localhost/safetra_web/');
}
else
{
    $config['link_photo'] = 'http://safetra.co.id/upload/';
    
    define('WEB_HOST', 'http://safetra.co.id/');
}

$config['link_logo'] = WEB_HOST.'assets/images/logo.png';
$config['title'] = 'Safetra Indonesia';

$config['default_admin_order'] = array('name', 'role', 'status', 'created_date');
$config['default_admin_role'] = array('1', '2');
$config['default_admin_status'] = array('1');
$config['default_article_order'] = array('created_date');
$config['default_client_order'] = array('created_date', 'name');
$config['default_company_order'] = array('created_date', 'name', 'pic_name');
