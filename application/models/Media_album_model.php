...
class Media_album_model extends CI_Model {

    var $table = 'media_album';
    var $table_id = 'id_media_album';
    ...
    function info($param)
    {
        ...
        $this->db->select('id_media_album, name, slug, created_date, updated_date');
